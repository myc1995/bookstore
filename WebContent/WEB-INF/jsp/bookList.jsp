			...
			<div class="books">
				<div class="book">
					<a class="bookcover" href="<%=path%>/jsp/bookDetail.jsp"
						target="_blank"> <img src="<%=path%>/img/2016-07-15/santi.jpg"
						alt="三体全集（全3册）" />
					</a>
					<div class="bookinfo">
				...
				<div class="book">
					<a class="bookcover" href="<%=path%>/jsp/bookDetail.jsp"
						target="_blank"> <img
						src="<%=path%>/img/2016-07-15/shijianjianshi.jpg" alt="时间简史" />
					</a>
					<div class="bookinfo">
				...
				<div class="book">
					<a class="bookcover" href="<%=path%>/jsp/bookDetail.jsp"
						target="_blank"> <img
						src="<%=path%>/img/2016-07-15/biancheng.jpg" alt="边城" />
					</a>
					<div class="bookinfo">
				...
				<div class="book">
					<a class="bookcover" href="<%=path%>/jsp/bookDetail.jsp"
						target="_blank"> <img
						src="<%=path%>/img/2016-07-15/liaobuqidegaicibi.jpg" alt="了不起的盖茨比" />
					</a>
					<div class="bookinfo">
