		...
		<div class="address-add">
			...
			<form action="#" method="post">
				...
				<div class="text-input">
					<label for="consignee">收货人 *</label> <input id="consignee"
						name="consignee" type="text" value="蛋蛋" /> <span
						id="consigneeTip"></span>
				</div>

				<!-- 手机号 -->
				<div class="text-input">
					<label for="phone">手机号*</label> <input id="phone" name="phone"
						type="text" value="18000000001" /> <span id="phoneTip"></span>
				</div>

				<!-- 详细位置 -->
				<div class="text-input">
					<label for="location">详细位置 *</label> <input id="location"
						name="location" type="text" size="40" value="北京市 西城区 xxxx" /> <span
						id="locationTip"></span>
				</div>
