...
<div style="padding: 20px;">
	...
	<form id="userPasswordUpdateForm" class="easyui-form"
		data-options="url:'success.json'" method="post">

		<label>原密码</label> <input name="password" class="easyui-textbox"
			data-options="type:'password',required:true" /><br /> <label>新密码</label>
