...
<div style="padding: 20px;">
	...
	<form id="bookAddForm" class="easyui-form"
		data-options="url:'<%=path %>/book'" method="post"
		enctype="multipart/form-data">
		<input type='hidden' name='action' value='managerAddJson' />
		<label>图书名称：</label> <input name="name" class="easyui-textbox"
			data-options="required:true" /><br /> <label>作&nbsp&nbsp者：</label>
		<input name="author" class="easyui-textbox"
			data-options="required:true" /><br /> <label>价&nbsp&nbsp格：</label>
		...
		<label>出版社&nbsp：</label> <input name="press" class="easyui-textbox"
			...
			data-options="required:true" /><br /> <label>页&nbsp&nbsp数：</label>
		<input name="pageCount" class="easyui-numberbox"
			data-options="required:true,min:0" /><br /> <label>字&nbsp&nbsp数：</label>
		<input name="wordCount" class="easyui-numberbox"
			data-options="required:true,min:0" /><br /> <label>ISBN&nbsp&nbsp：</label>
